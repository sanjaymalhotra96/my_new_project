...
public class CompleteProfile4 extends Fragment {
    RecyclerView recyclerView;
    GridLayoutManager gridLayoutManager;
    CompleteProfileRecycler_Adaptor completeProfileRecycler_adaptor;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.complete_profile4, container, false);
        recyclerView=view.findViewById(R.id.recylcerview);
        completeProfileRecycler_adaptor=new CompleteProfileRecycler_Adaptor(this);
